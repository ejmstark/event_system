                    ...
                    <div class="col-md-8 single-property-content prp-style-1 ">
                        ...
                        <?php }?>
                            ...
                            <?php foreach($events as $x){ if($id == $x->user_id){
                                echo'
                                <div class="button navbar-right">
                                    <button class="navbar-btn nav-button login"> <a href ="'.site_url("/CEvent/deleteEvent/$e->event_id").'">Cancel Event </a></button>
                                </div>

                                <div class="button navbar-right">
                                    <button class="navbar-btn nav-button login"> <a href ="'.site_url("/CEvent/editEvent/$e->event_id").'">Edit Event </a></button>
                                </div>';
                            }} ?>
                        </div>
                    </div>
