                    ...
                    <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1 col-sm-12">
                        ...
                        <div class="search-form wow pulse" data-wow-delay="0.8s">
                            ...
                            <div class="form-group">
                                    <!-- <input name="searchDateMonth" type="date" class="form-control" placeholder="Key word"> -->
                                    ...
                                    if(!isset($_POST['searchWord'])){
                                        echo '<input name="searchWord" type="text" class="form-control" placeholder="Key word">';
                                    } else {
                                        echo '<input name="searchWord" type="text" class="form-control" placeholder="Key word" value="'.$_POST['searchWord'].'">';
                                    }
                                    ?>
