...
class CEvent extends CI_Controller {
	...
	public function updateEvent(){
		$this->load->model('events/mEvent','event');
		$dateStartUnformatted = date_create($this->input->post('event_date_start'));
		$dateEndUnformatted = date_create($this->input->post('event_date_end'));

		$event_date_start = date_format($dateStartUnformatted, "Y-m-d H:i:s");
		$event_date_end = date_format($dateEndUnformatted, "Y-m-d H:i:s");
